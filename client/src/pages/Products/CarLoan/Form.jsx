  ...
  return (
    <div className="py-10">
      ...
      <h1 className="text-xl flex mb-8 flex-col space-y-2 font-semibold text-gray-500">
        <span>
          Unlock the best <span>Car Loan</span> offers suitable for
        ...
        <div>
          ...
          <div className="flex gap-2 bg-gray-200/40 border-[1px] border-gray-400 rounded-md">
            <select
              className="bg-transparent w-full py-2.5"
              name="buyCarType"
              value={formData.buyCarType}
              onChange={(e) =>
                dispatch(
                  setFormData({ ...formData, buyCarType: e.target.value })
                )
              }
            >
              <option value={""}>Select</option>
            ...
            <div>
              ...
              <div className="border-b border-slate-400 py-1">
                <input
                  placeholder=""
                  type="text"
                  name="oldCarRegistartionYear"
                  value={formData.oldCarRegistartionYear}
                  onChange={(e) =>
                    dispatch(
                      setFormData({
                        ...formData,
                        oldCarRegistartionYear: e.target.value,
                      })
                    )
                  }
                  className="bg-transparent w-full outline-none border-none placeholder:text-slate-500"
            ...
            <div>
              ...
              <div className="border-b border-slate-400 py-1">
                <input
                  ...
                  value={formData.oldCarVehicleNumber}
                  onChange={(e) =>
                    dispatch(
                      setFormData({
                        ...formData,
                        oldCarVehicleNumber: e.target.value,
                      })
                    )
                  }
                  className="bg-transparent w-full outline-none border-none placeholder:text-slate-500"
            ...
            <div>
              ...
              <div className="border-b border-slate-400 py-1">
                <input
                  ...
                  type="text"
                  name="valueOfOldCar"
                  value={formData.valueOfOldCar}
                  onChange={(e) =>
                    dispatch(
                      setFormData({
                        ...formData,
                        valueOfOldCar: e.target.value,
                      })
                    )
                  }
                  className="bg-transparent w-full outline-none border-none placeholder:text-slate-500"
            ...
            <div>
              ...
              <div className="border-b border-slate-400 py-1">
                <input
                  ...
                  value={formData.carInsuranceNumber}
                  onChange={(e) =>
                    dispatch(
                      setFormData({
                        ...formData,
                        carInsuranceNumber: e.target.value,
                      })
                    )
                  }
                  className="bg-transparent w-full outline-none border-none placeholder:text-slate-500"
            ...
            <div>
              ...
              <div className="border-b border-slate-400 py-1">
                <input
                  ...
                  type="text"
                  name="carOnroadPrice"
                  value={formData.carOnroadPrice}
                  onChange={(e) =>
                    dispatch(
                      setFormData({
                        ...formData,
                        carOnroadPrice: e.target.value,
                      })
                    )
                  }
                  className="bg-transparent w-full outline-none border-none placeholder:text-slate-500"
            ...
            <div>
              ...
              <div className="border-b border-slate-400 py-1">
                <input
                  ...
                  value={formData.carShowroomPrice}
                  onChange={(e) =>
                    dispatch(
                      setFormData({
                        ...formData,
                        carShowroomPrice: e.target.value,
                      })
                    )
                  }
                  className="bg-transparent w-full outline-none border-none placeholder:text-slate-500"
                ...
                <select
                  ...
                  onChange={(e) =>
                    dispatch(
                      setFormData({
                        ...formData,
                        carInsuranceType: e.target.value,
                      })
                    )
                  }
                >
