...
const Form = ({ states, cities, selectedState, setSelectedState, user }) => {
  ...
  const validationSchema = Yup.object({
    ...
    leasePropertyValue: Yup.number()
      ...
      .required("* required"),
    leasePropertyDuration: Yup.number()
      .integer("Invalid input")
      .required("* required"),
    monthlyIncomeThroughLease: Yup.number()
      .integer("Invalid input")
      .required("* required"),
    totalAmountToBeReceivedFromLease: Yup.number()
      .integer("Invalid input")
      .required("* required"),
  });
  ...
  return (
    <div className="py-10">
      ...
      <h1 className="text-xl flex mb-8 flex-col space-y-2 font-semibold text-gray-500">
        <span>
          Unlock the best <span>Lease Rent Discounting</span> offers suitable for
            ...
            <input
              ...
              value={
                formik.values.employmentType === "Salaried"
                  ...
                  : Number(formData.previousYearNetProfit) +
                    Number(formik.values.monthlyIncomeThroughLease) * 12
              }
              onChange={(e) =>
                dispatch(
            ...
            <div>
              ...
              <div className="border-b border-slate-400 py-1">
                <input
                  ...
                  value={formData.previousYearNetProfit}
                  onChange={(e) =>
                    dispatch(
                      setFormData({
                        ...formData,
                        previousYearNetProfit: e.target.value,
                      })
                    )
                  }
                  className="bg-transparent w-full outline-none border-none placeholder:text-slate-500"
