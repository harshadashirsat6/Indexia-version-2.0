...
const Form = ({ states, cities, selectedState, setSelectedState, user }) => {
  ...
  const validationSchema = Yup.object({
    ...
    enrollmentStatus: Yup.string("").required("* required"),
    courseDuration: Yup.string("").required("* required"),
    educationCost: Yup.string("").required("* required"),
  });
  ...
  return (
    <div className="py-10">
      ...
      >
        ...
        <div className="col-span-1 sm:col-span-2">
          <span className="font-bold ">EDUCATION & UNIVERSITY DETAILS</span>
        </div>
        <div>
          ...
          <div className="flex gap-2 bg-gray-200/40 border-[1px] border-gray-400 rounded-md">
            <select
              ...
              onChange={(e) =>
                dispatch(setFormData({ ...formData, country: e.target.value }))
              }
            >
        ...
        <div>
          ...
          <div className="border-b border-slate-400 py-1">
            <input
              placeholder=""
              type="text"
              {...formik.getFieldProps("Enrollment Status")}
              className="bg-transparent w-full outline-none border-none placeholder:text-slate-500"
            />
          </div>
        ...
        <div>
          <span className="font-semibold text-gray-500">
            Date of Birth{" "}
            <sapn className="text-sm font-mono">(As per pan card)</sapn>
          </span>
            ...
            >
              ...
              <div className={activeCl ? "hidden" : "block "}>
                <DatePicker
                  ...
                  handaleDate={(date) => {
                    formik.setFieldValue("parentDob", date);
                  }}
                  clearFun={() => {
                    formik.setFieldValue("parentDob", "");
                  }}
                  date={formik.parentDob}
                />
              </div>
            </div>
          </div>
        ...
        <div>
          <span className="font-semibold text-gray-500">
            Date of Birth{" "}
            <sapn className="text-sm font-mono">
