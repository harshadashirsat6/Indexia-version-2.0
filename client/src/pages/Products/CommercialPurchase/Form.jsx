  ...
  return (
    <div className="py-10">
      ...
      <h1 className="text-xl flex mb-8 flex-col space-y-2 font-semibold text-gray-500">
        <span>
          Unlock the best <span>Commercial Purchase Loan</span> offers suitable
          for your needs from <span>43+ lenders</span>
        </span>
      ...
      >
        ...
        <div className="">
          ...
          <div className="flex gap-2 bg-gray-200/40 border-[1px] border-gray-400 rounded-md">
            <select
              ...
              value={formData.commercialLoanAmount}
              onChange={(e) =>
                dispatch(
                  setFormData({
                    ...formData,
                    commercialLoanAmount: e.target.value,
                  })
                )
              }
            >
              <option value={""}>Select</option>
              {commercialLoanAmount.map((ele) => {
                return (
        ...
        <div className="">
          ...
          <div className="flex gap-2 bg-gray-200/40 border-[1px] border-gray-400 rounded-md">
            ...
            >
              <option value="">Select</option>
              {commercialPropertyType.map((ele, i) => {
                return (
                  <option key={ele} value={ele}>
                    {ele}
                  </option>
