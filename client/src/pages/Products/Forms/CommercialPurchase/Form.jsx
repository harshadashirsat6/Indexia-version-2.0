...
const Form = () => {
  const { commpurchaseForm } = useSelector((store) => store.loanForm);
  ...
  const [loanTypesArr, setLoanTypesArr] = useState(
    commpurchaseForm.existingLoanExposure
  );
  ...
  const validationSchema = Yup.object({
    ...
    propertyValue: Yup.number().integer("Invalid input").required("* required"),
    propertyAge: Yup.number().integer("Invalid input").required("* required"),
  });

  const formik = useFormik({
    initialValues: commpurchaseForm,
