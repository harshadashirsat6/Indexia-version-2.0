...
const Form = () => {
  ...
  const [requiredLoanTenureErr, setLapRequiredLoanTenureErr] = useState(false);
  ...
  const validationSchema = Yup.object({
    ...
    dateOfBirth: Yup.string("")
      .required("* required")
      .test("age-check", "Age must be greater than 23 years", function (value) {
      ...
      .test("age-check", "Age must be less than 63 years", function (value) {
        const currentDate = new Date();
        const selectedDate = new Date(value.split("-").reverse().join("-"));
        const age = currentDate.getFullYear() - selectedDate.getFullYear();
        // Adjust the age check as per your specific requirements
    ...
    <form onSubmit={formik.handleSubmit} className="py-10">
      <div className="block lg:grid lg:grid-cols-2 gap-10 ">
        ...
        <LoanRequirements
          formik={formik}
          setEmiErr={setEmiErr}
          setLapRequiredLoanTenureErr={setLapRequiredLoanTenureErr}
