...
// selectors
import { businessLoanEmploymentTypes } from "../../../../configs/selectorConfigs";
// components
...
const Form = () => {
  const { blForm } = useSelector((store) => store.loanForm);
      ...
      if (!formik.values.employmentType) {
        ...
        if (formik.values.employmentType === "Salaried") {
          ...
          if (
            ...
            return (
              <span className="text-red-500 text-xs font-bold">
                Invalid. EMI will be calculated based on previous year net
                profit
              </span>
            );
        ...
        <div className="">
          ...
          <div className="flex gap-2 bg-gray-200/40 border-[1px] border-gray-400 rounded-md">
            ...
            >
              ...
              {businessLoanEmploymentTypes.map((ele) => {
                return (
