...
const Form = () => {
  const { carlForm } = useSelector((store) => store.loanForm);
  ...
  const validationSchema = Yup.object({
    ...
    buyCarType: Yup.string("").required("* required"),
  });

  const formik = useFormik({
    initialValues: carlForm,
