...
const Form = () => {
  ...
  const [requiredloanAmountErr, setRequiredLoanAmountErr] = useState(false);
  ...
  const validationSchema = Yup.object({
    ...
    //personal details validation (STUDENT)
    ...
    courseDuration: Yup.number()
      ...
      .required("* required"),
    educationCost: Yup.number().integer("Invalid input").required("* required"),
    // personal details(PARENT)
    parentRelation: Yup.string("").required("* required"),
    ...
    parentResidenceState: Yup.string("").required("* required"),
    parentResidenceCity: Yup.string("").required("* required"),
    parentResidencePincode: Yup.number()
      .integer("Invalid pincode")
      .required("* required")
      .test("length-check", "Invalid pincode", function (value) {
        return value.toString().length === 6;
      }),
    parentResidenceStatus: Yup.string("").required("* required"),
  });

  const formik = useFormik({
    initialValues: edulForm,
