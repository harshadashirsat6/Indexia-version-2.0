  ...
  return (
    <div className="py-10">
      ...
      >
        ...
        <div>
          ...
          <div className="border-b border-slate-400 py-1">
            <select
              ...
              value={formData.existingCreditCardStatus}
              onChange={(e) =>
                dispatch(
                  setFormData({
                    ...formData,
        ...
        {formData.existingCreditCardStatus === "Yes" ? (
          <>
            <div>
              <span className="font-semibold text-gray-500">
              ...
              <div className="border-b border-slate-400 py-1">
                <select
                  ...
                  value={formData.existingCreditCardBankName}
                  onChange={(e) =>
                    dispatch(
                      setFormData({
                        ...formData,
            ...
            {formData.existingCreditCardBankName === "Other" ? (
              <div>
                <span className=" font-semibold text-gray-500">
                ...
                <div className="border-b border-slate-400 py-1">
                  <input
                    placeholder=""
                    type="text"
                    name="otherExistingCreditCardBankName"
                    value={formData.otherExistingCreditCardBankName}
                    onChange={(e) =>
                      dispatch(
                        setFormData({
                          ...formData,
            ...
            <div>
              ...
              <div className="border-b border-slate-400 py-1">
                <input
                  ...
                  value={formData.exisitingCreditCardLimit}
                  onChange={(e) =>
                    dispatch(
                      setFormData({
                        ...formData,
        ...
        <div>
          ...
          <div className="border-b border-slate-400 py-1">
            <select
              ...
              value={formData.newCreditCardBankName}
              onChange={(e) =>
                dispatch(
                  setFormData({
                    ...formData,
        ...
        {formData.newCreditCardBankName === "Other" ? (
          <div>
            <span className=" font-semibold text-gray-500">
            ...
            <div className="border-b border-slate-400 py-1">
              <input
                placeholder=""
                type="text"
                name="otherNewCreditCardBankName"
                value={formData.otherNewCreditCardBankName}
                onChange={(e) =>
                  dispatch(
                    setFormData({
                      ...formData,
