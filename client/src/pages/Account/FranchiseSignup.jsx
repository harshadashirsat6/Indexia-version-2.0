...
const FranchiseSignup = ({ formType, setFormType }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      const resp = await axios.post("/franchise/signup", formData);
      console.log(resp);
  ...
  return (
    <div className="mx-auto mt-8 p-6 bg-white/30 shadow-md rounded-md">
      <div>
        <h2 className="text-lg font-bold text-gray-500 ">Franchise Signup</h2>
